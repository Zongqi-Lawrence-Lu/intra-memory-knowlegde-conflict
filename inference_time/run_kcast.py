...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--experiment_name", default=None, help="default: kcast_default[_T{T}]")
...
def main():
    ...
    if args.experiment_name is None:
        args.experiment_name = default_experiment_name("kcast_default", args)
    ...
    if args.bank_file is None and pdir is not None:
        args.bank_file = str(pdir / "bank.json")
